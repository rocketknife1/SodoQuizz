...
const _discordInviteUrl = 'https://discord.gg/42ptHhYv2Q';
...
class _DiscordMascotState extends State<DiscordMascot> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _idle = RepeatingAnimationController(vsync: this, duration: const Duration(seconds: 4))..repeat();
    ...
    _bubbleCycle = RepeatingAnimationController(
      vsync: this,
